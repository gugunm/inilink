export default function PrivacyPolicy() {
  return (
    <>
      <h1>Privacy Policy for Inilink</h1>

      <p>
        At Inilink Project, accessible from https://inilink.vercel.app, one of
        ...
        Inilink Project and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Inilink Project. This policy is not applicable
      ...
      <p>
        Inilink Project follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Inilink Project uses 'cookies'. These cookies
      ...
      <p>
        ...
        advertising partners of Inilink Project.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Inilink Project, which are sent
      ...
      <p>
        Note that Inilink Project has no access to or control over these cookies
      ...
      <p>
        Inilink Project's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Inilink Project does not knowingly collect any Personal Identifiable
